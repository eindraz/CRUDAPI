package com.wahyuindra.crudapi

import com.wahyuindra.crudapi.Model.ResultStaff
...
object NetworkConfig {
    ...
    fun getRetrofit(): Retrofit {
        return Retrofit.Builder()
            .baseUrl("http://10.0.2.2/ci3_api/index.php/ServerApi/")
            //.baseUrl("http://192.168.1.7/ci3_api/index.php/ServerApi/")
